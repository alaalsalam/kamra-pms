...
def _finance_slice(property: str, date: str):
	...
	from hotelpms.api import cash_summary
...
@frappe.whitelist()
@require_roles("Front Desk", "Finance", "Revenue Manager", "Hotel Admin", "HotelPMS Agent")
def property_dashboard(property: str, date: str | None = None):
	...
	from hotelpms.reports import manager_flash
...
def _property_summary(property: str, date: str):
	...
	from hotelpms.reports import _day_stats
...
@frappe.whitelist()
@require_roles("Finance", "Revenue Manager", "Hotel Admin", "HotelPMS Agent")
def portfolio_dashboard(date: str | None = None):
	...
	date = date or nowdate()
	from hotelpms.api import my_properties
