...
way. See hotelpms/hotelpms/doctype/venue_booking/venue_booking.py.
"""
...
BANQUET_ROLES = ("Front Desk", "Revenue Manager", "HotelPMS Agent")
...
def venue_availability(property: str, event_date: str,
	...
	from hotelpms.hotelpms.doctype.venue_booking.venue_booking import overlapping
...
def run_banquet_reminders():
	...
	from hotelpms.housekeeping import _notify_role
	from hotelpms.savings import log_action
...
def post_to_folio(function: str, folio: str | None = None):
	...
	from hotelpms.api import add_folio_charge
...
def issue_indent(function: str, outlet: str, rows=None):
	...
	from hotelpms.inventory import _apply_move
...
def venue_detail(venue: str):
	...
	from hotelpms.hotelpms.doctype.venue_booking.venue_booking import clashing_venues
