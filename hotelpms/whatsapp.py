...
The open-source half of HotelPMS's WhatsApp story (the managed gateway and
...
def send_payment_request(reservation: str, amount, note: str = "") -> dict:
	...
	"""
	from hotelpms.authz import require_roles  # noqa: F401  (role gate below)
...
def webhook(**kwargs):
	...
	Point Meta at /api/method/hotelpms.whatsapp.webhook and subscribe to
...
def _handle_inbound(value: dict) -> None:
	...
	from hotelpms.agents_channels import _resolve_caller
