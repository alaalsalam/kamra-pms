...
Run with:
    bench --site hotelpms.localhost execute hotelpms.scripts.bootstrap_v1.execute
...
def execute():
	...
	print("HotelPMS v1 schema (meal plans, seasons, vouchers, groups, corporate) ready.")
