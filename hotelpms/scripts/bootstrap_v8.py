...
Run via bench console:
    from hotelpms.scripts.bootstrap_v8 import execute; execute()
"""

import frappe

from hotelpms.scripts.bootstrap_schema import _dt, f
from hotelpms.scripts.bootstrap_v5 import add_fields
from hotelpms.scripts.fix_perms_fields import _grant
...
PERMS = {
	"Travel Agent": {
		...
		"Finance": (1, 0, 0), "HotelPMS Agent": (1, 0, 0),
	},
	"Venue": {
		"System Manager": (1, 1, 1), "Hotel Admin": (1, 1, 1),
		"Revenue Manager": (1, 1, 1), "Front Desk": (1, 0, 0),
		"HotelPMS Agent": (1, 0, 0),
	},
	"Venue Booking": {
		"System Manager": (1, 1, 1), "Hotel Admin": (1, 1, 1),
		"Front Desk": (1, 1, 1), "Finance": (1, 0, 0),
		"HotelPMS Agent": (1, 1, 1),
	},
	"Lost And Found Item": {
		"System Manager": (1, 1, 1), "Hotel Admin": (1, 1, 1),
		"Front Desk": (1, 1, 1), "HotelPMS Agent": (1, 1, 1),
	},
	"Shift Handover": {
		"System Manager": (1, 1, 1), "Hotel Admin": (1, 1, 1),
		"Front Desk": (1, 1, 1), "Finance": (1, 0, 0),
...
def execute():
	...
	print("HotelPMS v8 schema (operational long tail) ready.")
