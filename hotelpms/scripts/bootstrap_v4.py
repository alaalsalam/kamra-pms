...
Run via bench console:
    from hotelpms.scripts.bootstrap_v4 import execute; execute()
"""
...
def execute():
	...
	for role, grants in {
		...
		"Front Desk": (1, 0, 0, 0),
		"HotelPMS Agent": (1, 0, 0, 0),  # agents may READ guardrails, never edit
	}.items():
		r, w, c, d = grants
	...
	print("HotelPMS v4 schema (rate guardrails) ready.")
