...
Run via bench console:
    from hotelpms.scripts.bootstrap_v10 import execute; execute()
"""

import frappe

from hotelpms.scripts.bootstrap_schema import f
from hotelpms.scripts.bootstrap_v2 import _dt
from hotelpms.scripts.fix_perms_fields import _grant

ROLES_RW = ("System Manager", "Hotel Admin", "Front Desk", "HotelPMS Agent")
...
def execute():
	...
	for doctype in ("POS Outlet", "Menu Item", "POS Order", "Experience"):
		for role in ROLES_RW:
			write = 0 if (role == "HotelPMS Agent" and doctype != "POS Order") else 1
	...
	print("HotelPMS v10 schema (POS + experiences) ready.")
