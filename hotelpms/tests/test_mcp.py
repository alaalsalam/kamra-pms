...
from hotelpms import mcp_http, mcp_oauth
from hotelpms.mcp_tools import BY_NAME
from hotelpms.tests.fixtures import PROPERTY, build, ensure_roles_and_users
...
class TestRemoteMCP(IntegrationTestCase):
	...
	def test_front_desk_does_not_see_set_room_rate(self):
		from hotelpms.mcp_tools import allowed_tools, tool_allowed
