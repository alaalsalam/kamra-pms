...
from hotelpms.mcp_oauth import (
...
def _unauthorized() -> Response:
	resp = _json(
		{
			"error": "invalid_token",
			"error_description": "Sign in with OAuth to use HotelPMS MCP.",
		},
		401,
	)
	resp.headers["WWW-Authenticate"] = (
		'Bearer realm="HotelPMS", '
...
def _dispatch_method(method: str, params: dict, grant) -> dict:
	if method == "initialize":
		...
		return {
			...
			"serverInfo": {"name": "hotelpms", "version": str(TOOL_COUNT), "title": "HotelPMS"},
